    ...
    return (
        <footer className="bg-[#1F1F1F] p-4 text-center mt-auto">
            ...
            <div className="flex justify-center space-x-4 mt-4">
                ...
                <a href="https://x.com/youthspark" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-[#BFBFBF] hover:text-[#FCD12A]"><svg viewBox="0 0 24 24" className="w-6 h-6 fill-current"><path d="M18.243 2H21.439L14.474 9.947L22.666 22H16.248L11.22 15.429L5.474 22H2.277L9.742 13.456L1.867 2H8.472L13.018 8.016L18.243 2ZM17.13 20.219H18.899L7.498 3.666H5.613L17.13 20.219Z" /></svg></a>
            </div>
        </footer>
    );
};
